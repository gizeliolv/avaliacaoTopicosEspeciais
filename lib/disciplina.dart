...
import 'integracaoDisciplina.dart';
...
class _RequirementState extends State<Disciplina> {
  @override
  ...
  Widget _buildBody(BuildContext) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('Disciplina').snapshots(),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          subtitle: Text(record.media.toString()),

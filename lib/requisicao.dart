...
class _RequirementState extends State<Requisicao> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: Text('Requisicao'),
      ),
  ...
  Widget _buildBody(BuildContext) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('Requisicao').snapshots(),    /* {coment} instanciado a colecao/banco requisicao */
  ...
  Widget _buildListItemReq(BuildContext context, DocumentSnapshot data) {
    ...
    return Padding(
      key: ValueKey(record.disciplina),
      ...
      child: Container(
        ...
        child: ListTile(
          title: Text(record.disciplina),  /* {coment} colocado os valores para listar */
          subtitle: Text(record.aluno.toString()), /* {coment} aqui nessa coluna não sei se deveria alterar, precisa testar*/
